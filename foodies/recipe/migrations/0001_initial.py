...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('recipe_recipe', (
            ...
            ('prep_steps', self.gf('django.db.models.fields.TextField')()),
            ('time_to_prepare', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.create_table('recipe_ingredient', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ingredients', to=orm['recipe.Recipe'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal('recipe', ['Ingredient'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('recipe_ingredient')
